...
Nl80211CommandToString(nl80211_commands command) noexcept
{
	...
	case NL80211_CMD_NEW_BEACON: return "NL80211_CMD_NEW_BEACON"; // NL80211_CMD_START_AP
	case NL80211_CMD_DEL_BEACON: return "NL80211_CMD_DEL_BEACON"; // NL80211_CMD_STOP_AP
	...
	case NL80211_CMD_REGISTER_ACTION: return "NL80211_CMD_REGISTER_ACTION"; // NL80211_CMD_REGISTER_FRAME
	case NL80211_CMD_ACTION: return "NL80211_CMD_ACTION"; // NL80211_CMD_FRAME
	case NL80211_CMD_ACTION_TX_STATUS: return "NL80211_CMD_ACTION_TX_STATUS"; // NL80211_CMD_FRAME_TX_STATUS
    ...
    default: return "NL80211_CMD_UNKNOWN"; // this name does not correspond to a real command
    }
    // clang-format on
}
...
nL80211InterfaceTypeToString(nl80211_iftype interfaceType) noexcept
{
    ...
    default: return "NL80211_IFTYPE_UNKNOWN";
    }
}
